...
import type { AccordionGroupChangeEventDetail as IIonAccordionGroupAccordionGroupChangeEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'htmlAttributes', 'isOpen', 'keyboardClose', 'leaveAnimation', 'subHeader', 'translucent', 'trigger'],
...
import type { OverlayEventDetail as IIonActionSheetOverlayEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'htmlAttributes', 'inputs', 'isOpen', 'keyboardClose', 'leaveAnimation', 'message', 'subHeader', 'translucent', 'trigger'],
  methods: ['present', 'dismiss', 'onDidDismiss', 'onWillDismiss']
})
@Component({
  selector: 'ion-alert',
...
import type { OverlayEventDetail as IIonAlertOverlayEventDetail } from 'stencil-library';
...
import type { BreadcrumbCollapsedClickEventDetail as IIonBreadcrumbsBreadcrumbCollapsedClickEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['checked', 'color', 'disabled', 'indeterminate', 'justify', 'labelPlacement', 'legacy', 'name', 'value']
})
@Component({
...
import type { CheckboxChangeEventDetail as IIonCheckboxCheckboxChangeEventDetail } from 'stencil-library';
...
import type { ScrollBaseDetail as IIonContentScrollBaseDetail } from 'stencil-library';
import type { ScrollDetail as IIonContentScrollDetail } from 'stencil-library';
...
import type { DatetimeChangeEventDetail as IIonDatetimeDatetimeChangeEventDetail } from 'stencil-library';
...
import type { InputInputEventDetail as IIonInputInputInputEventDetail } from 'stencil-library';
import type { InputChangeEventDetail as IIonInputInputChangeEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['animated', 'backdropDismiss', 'cssClass', 'duration', 'enterAnimation', 'htmlAttributes', 'isOpen', 'keyboardClose', 'leaveAnimation', 'message', 'showBackdrop', 'spinner', 'translucent', 'trigger'],
  methods: ['present', 'dismiss', 'onDidDismiss', 'onWillDismiss']
})
@Component({
...
import type { OverlayEventDetail as IIonLoadingOverlayEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['animated', 'backdropBreakpoint', 'backdropDismiss', 'breakpoints', 'canDismiss', 'enterAnimation', 'handle', 'handleBehavior', 'htmlAttributes', 'initialBreakpoint', 'isOpen', 'keepContentsMounted', 'keyboardClose', 'leaveAnimation', 'presentingElement', 'showBackdrop', 'trigger'],
...
import type { OverlayEventDetail as IIonModalOverlayEventDetail } from 'stencil-library';
import type { ModalBreakpointChangeEventDetail as IIonModalModalBreakpointChangeEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['animated', 'backdropDismiss', 'buttons', 'columns', 'cssClass', 'duration', 'enterAnimation', 'htmlAttributes', 'isOpen', 'keyboardClose', 'leaveAnimation', 'showBackdrop', 'trigger'],
...
import type { OverlayEventDetail as IIonPickerOverlayEventDetail } from 'stencil-library';
...
import type { PickerColumnItem as IIonPickerColumnInternalPickerColumnItem } from 'stencil-library';
...
import type { PickerInternalChangeEventDetail as IIonPickerInternalPickerInternalChangeEventDetail } from 'stencil-library';
...
import type { OverlayEventDetail as IIonPopoverOverlayEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['color', 'disabled', 'justify', 'labelPlacement', 'legacy', 'name', 'value']
})
@Component({
  selector: 'ion-radio',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
import type { RadioGroupChangeEventDetail as IIonRadioGroupRadioGroupChangeEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['activeBarStart', 'color', 'debounce', 'disabled', 'dualKnobs', 'label', 'labelPlacement', 'legacy', 'max', 'min', 'name', 'pin', 'pinFormatter', 'snaps', 'step', 'ticks', 'value']
})
@Component({
  selector: 'ion-range',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
import type { RangeChangeEventDetail as IIonRangeRangeChangeEventDetail } from 'stencil-library';
import type { RangeKnobMoveStartEventDetail as IIonRangeRangeKnobMoveStartEventDetail } from 'stencil-library';
import type { RangeKnobMoveEndEventDetail as IIonRangeRangeKnobMoveEndEventDetail } from 'stencil-library';
...
import type { RefresherEventDetail as IIonRefresherRefresherEventDetail } from 'stencil-library';
...
import type { ItemReorderEventDetail as IIonReorderGroupItemReorderEventDetail } from 'stencil-library';
...
import type { RouterEventDetail as IIonRouterRouterEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['animated', 'autocomplete', 'autocorrect', 'cancelButtonIcon', 'cancelButtonText', 'clearIcon', 'color', 'debounce', 'disabled', 'enterkeyhint', 'inputmode', 'name', 'placeholder', 'searchIcon', 'showCancelButton', 'showClearButton', 'spellcheck', 'type', 'value'],
  methods: ['setFocus', 'getInputElement']
})
@Component({
...
import type { SearchbarInputEventDetail as IIonSearchbarSearchbarInputEventDetail } from 'stencil-library';
import type { SearchbarChangeEventDetail as IIonSearchbarSearchbarChangeEventDetail } from 'stencil-library';
...
import type { SegmentChangeEventDetail as IIonSegmentSegmentChangeEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['cancelText', 'color', 'compareWith', 'disabled', 'expandedIcon', 'fill', 'interface', 'interfaceOptions', 'justify', 'label', 'labelPlacement', 'legacy', 'multiple', 'name', 'okText', 'placeholder', 'selectedText', 'shape', 'toggleIcon', 'value'],
  methods: ['open']
})
@Component({
  selector: 'ion-select',
...
import type { SelectChangeEventDetail as IIonSelectSelectChangeEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['autoGrow', 'autocapitalize', 'autofocus', 'clearOnEdit', 'color', 'cols', 'counter', 'counterFormatter', 'debounce', 'disabled', 'enterkeyhint', 'errorText', 'fill', 'helperText', 'inputmode', 'label', 'labelPlacement', 'legacy', 'maxlength', 'minlength', 'name', 'placeholder', 'readonly', 'required', 'rows', 'shape', 'spellcheck', 'value', 'wrap'],
  methods: ['setFocus', 'getInputElement']
})
@Component({
...
import type { TextareaChangeEventDetail as IIonTextareaTextareaChangeEventDetail } from 'stencil-library';
import type { TextareaInputEventDetail as IIonTextareaTextareaInputEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['animated', 'buttons', 'color', 'cssClass', 'duration', 'enterAnimation', 'header', 'htmlAttributes', 'icon', 'isOpen', 'keyboardClose', 'layout', 'leaveAnimation', 'message', 'position', 'translucent', 'trigger'],
  methods: ['present', 'dismiss', 'onDidDismiss', 'onWillDismiss']
})
@Component({
  selector: 'ion-toast',
...
import type { OverlayEventDetail as IIonToastOverlayEventDetail } from 'stencil-library';
...
@ProxyCmp({
  inputs: ['checked', 'color', 'disabled', 'enableOnOffLabels', 'justify', 'labelPlacement', 'legacy', 'name', 'value']
})
@Component({
  selector: 'ion-toggle',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
import type { ToggleChangeEventDetail as IIonToggleToggleChangeEventDetail } from 'stencil-library';
