...
2. The generated component.ts includes *all* components from @ionic/core, it does not filter the components really used. In example, the `custom-component` does not use `ion-accordeon` but in generated `angular-workspace/projects/custom-component-ng/src/lib/stencil-generated/component.ts` I can find:
